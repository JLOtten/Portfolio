    ...
    <section className='mb-28 max-w-[50rem] text-center sm:mb-0'>
        <div className="flex flex-col items-center justify-center ">
            <div className="relative">
                ...
                quality="95"
                priority={true}
                className='h-24.25 w-24.25 rounded-full 
                object-cover border-[0.35rem]
                 border-white shadow-xl'
                />   
                </motion.div>
                <motion.span className="absolute 
                bottom-0 right-0 text-6xl"
                    initial={{ opacity:0, scale:0 }}
                    animate={{ opacity:1, scale:1 }}
                    transition={{
                        type: "spring",
            ...
            >
                Hi, <span className='font-bold'>I'm Jenna.</span> I'm a <span className='font-bold'>UX engineer</span> with 
                a focus on front-end. I love to build <span className='font-medium'>accessible</span> and <span className='font-medium'>responsive</span> web experiences.
            </motion.h1>
            ...
            text-lg font-medium'
                ...
                transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60'
                href="https://github.com/JLOtten" target="_blank">
                    <FaGithubSquare />
                </a>
