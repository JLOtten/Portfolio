...
export default function About() {
  ...
  <motion.section
    ...
    I enjoyed over 10 years teaching high school, elementary and adults the subjects of math, science and English as a Second Language. 
    ...
    where I used <span className='underline'>Figma, AdobeXD and UX Research & Design principles</span>. I simultaneously completed a front-end program, 
    to deepen my knowledge of <span className='underline'>JavaScript, HTML and CSS</span> and frameworks like <span className='underline'>React</span>. 
  When I'm not learning new technologies or coding, I'm likely walking my dogs or cheering at my kids' 
