...
export const metadata = {
  ...
  description: 'Jenna is a front-end developer and UX designer based in the Bay Area.',
}
  ...
  return (
    <html lang="en">
      ...
      sm:pt-36`}>
        ...
        <div className="bg-[#dbd7fb] absolute top-[-1rem] -z-10 left-[35rem] h-[50rem] w-[31.25rem] 
